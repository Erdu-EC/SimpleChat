...
<div id="layoutSidenav">
    <div id="layoutSidenav_nav" class="no-seleccionable">
        <div id="profile">
            <div class="wrap">
                <img id="profile-img" src="<?= $SESSION_USER_PROFILE_IMG ?>?w=80&h=80" class="online"
                     title="<?= $SESSION_USER_NAME ?>" alt=""/>
        ...
        <article id="frame">
            ...
            <div class="content" id="espacio-de-chat" style="display: none">
                ...
                <div class="message-input" id="espacio-de-escritura">
                    ...
                    <button class="btn modo-microfono" id="btn-enviar-mensaje" title="Grabar audio"><i
            ...
            <div class="no-seleccionable" id="panelInfoContacto">
                ...
                <div class="contenedor-perfil">
                    ...
                    <div class="card cont-imagenes-conversacion">
                        ...
                        <span class="icon-ver-todo inhabilitado" id="btn-ver-todo"><i class="fas fa-th-large"></i>Ver todo</span>
